...
class MySqlSourceAdapterBinlogFormatIT {
  @TempDir Path tempDir;

  @Test
  void failsClosedWhenBinlogFormatIsNotRow() throws Exception {
    ...
    try (MySQLContainer mysql =
      ...
      try (H2RuntimeStateStore stateStore =
          new H2RuntimeStateStore(tempDir.resolve("mysql-live-adapter-preflight-format"))) {
