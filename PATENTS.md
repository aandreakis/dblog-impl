# Patent Notice (Informational Only)
...
Public patent records include U.S. Patent No. 11,860,849, titled _"Watermark-based techniques for change-data-capture."_ Public records such as Google Patents currently identify Netflix, Inc. as the current assignee and currently show the patent as active, while also noting that their assignee and legal-status displays may be inaccurate and are not legal conclusions.
